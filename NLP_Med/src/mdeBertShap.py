...
def main():
    ...
    # Дополнительная визуализация для первого примера
    print("\nSHAP Values for First Example:")
    print("Predicted:", id2label[shap_values[0].output_names[0]])
    print("Actual:", id2label[sample_labels[0]])
